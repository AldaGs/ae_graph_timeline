...
| M4.6 | Pre-M7 editing completion | **IN PROGRESS** — source-backed footage import is implemented offline; installed AE acceptance, unmanaged-layer Import/Ignore, Monaco expression editing, installed-effect catalogue, and keyboard connection acceptance remain open. See `docs/M4.6.md`. |
